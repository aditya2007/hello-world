package com.java.core.companies.Apple;

/**
 * Java program to count islands in boolean 2D matrix
 *
 * https://www.quora.com/What-is-an-efficient-algorithm-to-find-an-island-of-connected-1s-in-a-matrix-of-0s-and-1shttps://www.quora.com/What-is-an-efficient-algorithm-to-find-an-island-of-connected-1s-in-a-matrix-of-0s-and-1s
 ...
 * Created by Yogananda Gowda - 212590467 on 6/9/17.
 *
 *
 ...
 * Such graph with only one connected component is called as Strongly Connected Graph.
 ...
 We will call DFS on the next un-visited component. The number of calls to DFS()
